...
migrate() {
    ...
    # Use interpolated seeding for each tracked file — the raw template
    # contains {{PROJECT_NAME}} / {{DESCRIPTION}} that must be resolved
    # before saving to .cco/base/, otherwise diffs show false conflicts.
