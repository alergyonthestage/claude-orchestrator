...
test_dry_run_no_persistent_artifacts() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_not_exists "$CCO_PROJECTS_DIR/test-proj/docker-compose.yml"
...
test_dry_run_compose_is_valid_yaml() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_valid_compose "$DRY_RUN_DIR/docker-compose.yml"
}
...
test_dry_run_compose_auto_generated_header() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "AUTO-GENERATED by cco CLI"
}
...
test_dry_run_container_name_convention() {
    ...
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "container_name: cc-alpha-proj"
}
...
test_dry_run_network_name_convention() {
    ...
    create_project "$tmpdir" "alpha-proj" "$(minimal_project_yml alpha-proj)"
    run_cco start "alpha-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "name: cc-alpha-proj"
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "driver: bridge"
}
...
test_dry_run_project_name_env_var() {
    ...
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "PROJECT_NAME=my-proj"
}
...
test_dry_run_teammate_mode_env_var() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "TEAMMATE_MODE=tmux"
}
...
test_dry_run_agent_teams_env_var() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMS=1"
}
...
test_dry_run_settings_json_mounted_readonly() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "settings.json:/home/claude/.claude/settings.json:ro"
}
...
test_dry_run_claude_md_mounted_readonly() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "CLAUDE.md:/home/claude/.claude/CLAUDE.md:ro"
}
...
test_dry_run_rules_mounted_readonly() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "rules:/home/claude/.claude/rules:ro"
}
...
test_dry_run_agents_mounted_readonly() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "agents:/home/claude/.claude/agents:ro"
}
...
test_dry_run_skills_mounted_readonly() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "skills:/home/claude/.claude/skills:ro"
}
...
test_dry_run_gitconfig_mounted_readonly() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" ".gitconfig:/home/claude/.gitconfig:ro"
}
...
test_dry_run_ssh_not_mounted() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_not_contains "$DRY_RUN_DIR/docker-compose.yml" ".ssh"
}
...
test_dry_run_global_mcp_mounted_when_present() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "mcp-global.json:ro"
}
...
test_dry_run_global_mcp_not_mounted_when_absent() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_not_contains "$DRY_RUN_DIR/docker-compose.yml" "mcp-global.json"
}
...
YAML
    ...
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "image: my-custom-image:v2"
}
...
test_dry_run_default_image_when_no_docker_image() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "image: claude-orchestrator:latest"
}
...
test_dry_run_docker_socket_not_mounted_by_default() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_not_contains "$DRY_RUN_DIR/docker-compose.yml" "docker.sock"
}
...
test_dry_run_setup_sh_not_mounted_when_missing() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_not_contains "$DRY_RUN_DIR/docker-compose.yml" "setup.sh"
}
...
test_dry_run_global_setup_not_mounted_when_missing() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_not_contains "$DRY_RUN_DIR/docker-compose.yml" "global-setup"
}
...
test_dry_run_mcp_packages_not_mounted_when_missing() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_not_contains "$DRY_RUN_DIR/docker-compose.yml" "mcp-packages.txt"
}
...
test_browser_disabled_by_default() {
    ...
    assert_file_not_exists "$DRY_RUN_DIR/.managed/browser.json"
}
...
YAML
    ...
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "host.docker.internal:host-gateway"
}
...
YAML
    ...
    run_cco start "test-proj" --dry-run
    local mcp_file="$DRY_RUN_DIR/.managed/browser.json"
...
YAML
    ...
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/.managed/browser.json" "localhost:9223"
}
...
YAML
    ...
    run_cco start "test-proj" --dry-run
    local port_file="$DRY_RUN_DIR/.managed/.browser-port"
...
YAML
    ...
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "CDP_PORT=9225"
}
...
test_browser_cdp_port_env_absent_when_disabled() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_not_contains "$DRY_RUN_DIR/docker-compose.yml" "CDP_PORT"
}
...
YAML
    ...
    assert_file_contains "$DRY_RUN_DIR/.managed/github.json" "modelcontextprotocol/server-github"
}
...
YAML
    ...
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/.managed/github.json" 'GITHUB_TOKEN'
    assert_file_contains "$DRY_RUN_DIR/.managed/github.json" '${GITHUB_TOKEN}'
}
...
YAML
    ...
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/.managed/github.json" '${GH_TOKEN}'
}
...
test_github_disabled_no_managed_json() {
    ...
    create_project "$tmpdir" "test-proj" "$(minimal_project_yml test-proj)"
    run_cco start "test-proj" --dry-run
    assert_file_not_exists "$DRY_RUN_DIR/.managed/github.json"
}
...
YAML
    ...
    run_cco start "test-proj" --dry-run
    assert_file_contains "$DRY_RUN_DIR/docker-compose.yml" "./.managed:/workspace/.managed:ro"
}
