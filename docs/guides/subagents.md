...
The orchestrator provides two default subagents (analyst and reviewer) defined at the global level (`global/.claude/agents/`). Projects can add their own subagents in `projects/<n>/.claude/agents/`.
