...
- **Generated at**: `projects/<name>/.cco/managed/policy.json`
- **Mounted at**: `/etc/cco/policy.json:ro`
- **Generated by**: `cmd-start.sh` (alongside docker-compose.yml)

### 7.3 Squid Config Location (Phase C)

- **Generated at**: `projects/<name>/.cco/managed/proxy/squid.conf` and `allowed_domains.txt`
...
volumes:
  ...
  # Policy config
  - ./.cco/managed/policy.json:/etc/cco/policy.json:ro
```
