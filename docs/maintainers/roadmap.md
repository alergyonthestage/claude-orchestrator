...
> stays project 014/global 016); suite **1197/7**. **▶ Only `cco build` on the Mac → e2e v2
> acceptance + push both branches remain.** Pre-merge open: **B-DF1**, config-editor `--project`
> host live-dogfood, Linux write-path check-in.
