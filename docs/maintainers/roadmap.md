...
> regressions). **▶ S3 Phase VI (REBUILD) is NEXT**: migrations (additive; project 015/global
> 017) + changelog #37 + DOC5 shipped-doc cutover + `design-docker.md` mount inventory +
> CLI-surface matrix B4/DI1 ⏳→final + `cco build` → e2e v2. Pre-merge open: **B-DF1**.
