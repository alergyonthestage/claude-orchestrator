...
> S1 Phase I (model `(G,Pc,Po)`) + S1 Phase II (privilege boundary) DONE + dogfooded on the Mac
> (boundary confirmed: `cat index` → EACCES); S2 Phase III (per-command A1 fixes) NEXT.**
