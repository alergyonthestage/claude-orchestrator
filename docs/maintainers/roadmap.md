...
`cco update` refactor, after C). ADR map: **0036** + **0041** (B — capability model +
R1), **0037** (C, ✅ shipped + released), **0038** (D), **0039** (E, ✅), **0040** (F).
Next free ADR = **0042**.
