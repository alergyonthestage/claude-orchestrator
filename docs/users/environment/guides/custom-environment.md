...
**File**: `<repo>/.cco/mcp-packages.txt`
...
```
# <repo>/.cco/mcp-packages.txt  (devops-toolkit)
...
```yaml
# <repo>/.cco/project.yml  (devops-toolkit)
name: devops-toolkit
...
```dockerfile
# <repo>/.cco/Dockerfile  (devops-toolkit)
